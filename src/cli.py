...
def set_config(service_name: str, environment: str, data: str):
    """Set configuration for a service. Data must be a valid JSON string."""
    try:
...
def update_config(service_name: str, environment: str, data: str):
    """Update existing configuration atomically. Data must be a valid JSON string."""
    try:
        json_data = json.loads(data)
